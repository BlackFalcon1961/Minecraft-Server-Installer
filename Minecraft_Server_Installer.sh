...
if [ "$startserver" = "y" ] || [ "$startserver" = "Y" ]; then
	...
	read -t 1 cooldownquit5
	cooldownquit5='5'
	echo "  Closing script in $cooldownquit5"
	read -t 1 cooldownquit4
	cooldownquit4='4'
	echo " "
	echo "  Closing script in $cooldownquit4"
	read -t 1 cooldownquit3
	cooldownquit3='3'
	echo " "
	echo "  Closing script in $cooldownquit3"
	read -t 1 cooldownquit2
	cooldownquit2='2'
	echo " "
	echo "  Closing script in $cooldownquit2"
	read -t 1 cooldownquit1
	cooldownquit1='1'
	echo " "
	echo "  Closing script in $cooldownquit1"
	read -t 1 cooldownquit0
	cooldownquit0='0'
	echo " "
	echo "  Closing script in $cooldownquit0"
	clear
	exit
}
